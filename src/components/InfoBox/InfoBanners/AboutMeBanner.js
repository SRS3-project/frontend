            ...
            <ContainerBox>
                <div type="about">
                    {authors.project.mail !== "" && 
                        <p id="about">
                            <HiOutlineMail 
                                onClick={()=> window.open(authors.project.mail)}
                                style={{
                                    width: "48px",
                                    "min-width": "48px",
                                    height: "36px"
                    ...
                    {authors.project.github !== "" &&
                        <p  id="about">
                            <AiFillGithub 
                                onClick={()=> window.open(authors.project.github)}
                                style={{
                                    width: "48px",
                                    "min-width": "48px",
                                    height: "36px"
                    ...
                    {authors.project.gitlab !== "" && 
                        <p id="about">
                            <AiFillGitlab 
                                onClick={()=> window.open(authors.project.gitlab)}
                                style={{
                                    width: "48px",
                                    "min-width": "48px",
                                    height: "36px"
                    ...
                    {authors.project.facebook !== "" && 
                        <p id="about">
                            <FaFacebookF 
                                onClick={()=> window.open(authors.project.facebook)}
                                style={{
                                    width: "48px",
                                    "min-width": "48px",
                                    height: "36px"
                    ...
                    {authors.project.instagram !== "" && 
                        <p id="about">
                            <FaInstagram 
                                onClick={()=> window.open(authors.project.instagram)}
                                style={{
                                    width: "48px",
                                    "min-width": "48px",
                                    height: "36px"
                    ...
                    {authors.project.twitter !== "" && 
                        <p id="about">
                            <FaTwitter 
                                onClick={()=> window.open(authors.project.twitter)}
                                style={{
                                    width: "48px",
                                    "min-width": "48px",
                                    height: "36px"
